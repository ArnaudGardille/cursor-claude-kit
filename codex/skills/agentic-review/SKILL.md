...
## When to use
Use when you need to review this repository as an **AI agent systems** reviewer (prompts, tools, schemas, orchestration, context, guardrails, observability, evals)—not a general code review.
...
- Is context isolated appropriately across subtasks, branches, or delegated review passes?
